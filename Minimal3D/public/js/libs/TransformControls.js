( function () {
	...
	class TransformControlsGizmo extends THREE.Object3D {
		...
		constructor() {
			...
			const matOrange = gizmoMaterial.clone();
			matOrange.color.set( 0x00ff00 ); // reusable geometry
			...
			const gizmoRotate = {
				...
				Y: [[ new THREE.Mesh( new THREE.TorusGeometry( 1, 0.02, 8, 48 ), matOrange ), null, [ Math.PI / 2, 0, 0 ]], [ new THREE.Mesh( new THREE.BoxGeometry( 0.1, 0.1, 0.1 ), matOrange ), [ 0, 0, 0.99 ]]],
